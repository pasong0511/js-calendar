...
function renderCalendar(targetElement, year, month, onReRender) {
...
export function addCalendar(targetElement, selecYear, selecMonth, selecdate) {
  ...
  const handleReRender = (year, month) => {
    renderCalendar(calendar, year, month, handleReRender)
  }

  //처음 시작했을 때 캘린더 랜더
  renderCalendar(calendar, viewYear, viewMonth, handleReRender)
